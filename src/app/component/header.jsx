...
const Header = ({
  ...
  return (
    <div className=" h-screen flex flex-none flex-col max-sm:fixed max-sm:z-50 justify-between items-center px-9 text-[var(--muted)] max-xl:flex-row max-xl:h-auto max-xl:w-full max-xl:py-5 max-xl:mb-12 max-lg:mb-0 max-lg:px-0 max-sm:justify-center">
        <div className="border-2 border-[var(--border)] h-[150px] max-xl:h-0 max-xl:w-[150px] max-md:w-[50px] max-sm:hidden"></div>
    <main className=" flex items-center justify-center gap-5 max-sm:backdrop-blur-xl max-sm:w-fit max-sm:flex max-sm:justify-center max-sm:items-center  max-sm:rounded-3xl max-sm:py-4 max-sm:px-5">
