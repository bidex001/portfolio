...
const SpotlightShell = ({ children, className = "" }) => {
  return (
    <section
      className={`relative isolate overflow-hidden rounded-[34px] border border-[var(--border)] bg-[linear-gradient(135deg,rgba(255,255,255,0.96),rgba(124,58,237,0.10),rgba(255,255,255,0.88))] shadow-[var(--shadow)] dark:bg-[linear-gradient(135deg,rgba(15,23,42,0.94),rgba(124,58,237,0.16),rgba(17,24,39,0.92))] ${className}`}
    >
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(248,250,252,0.15),rgba(248,250,252,0.82))] dark:bg-[linear-gradient(180deg,rgba(15,23,42,0.16),rgba(15,23,42,0.82))]" />
      </div>
